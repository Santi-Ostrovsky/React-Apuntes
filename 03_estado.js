...
Pueden declararse métodos especiales en los componentes de clase para correr código específicamente cuando los componentes son montados y/o desmontados.
    ...
    - componentWillUnmount() {...} --> Este método corre al eliminar el componente Clock del DOM. En este caso, es un buen lugar para interrumpir el timer con el método de JS 'clearInterval([...])'.
...
COSAS A SABER DE 'STATE':
    ...
    - Los datos fluyen hacia abajo. Ni los elementos padres ni los hijos saben si un componente tiene estado o no, ni tampoco importa si están definidos como funciones o como clases. Es por esto que los estados son llamados 'locales' o 'encapsulados', no son accesibles a otros componentes más que el que lo tiene y modifica:
